...
/**
 * WpRevsliderSlidesId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class WpRevsliderSlidesId implements java.io.Serializable {
    private static final long serialVersionUID = -368537742094480266L;
    ...
    /** default constructor */
    public WpRevsliderSlidesId() {}

    /** full constructor */
    public WpRevsliderSlidesId(Integer id, Integer sliderId, Integer slideOrder, String params, String layers, String settings) {
        this.id = id;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof WpRevsliderSlidesId))
            return false;
        WpRevsliderSlidesId castOther = (WpRevsliderSlidesId) other;
        ...
        return ((this.getId() == castOther.getId()) || (this.getId() != null && castOther.getId() != null && this.getId().equals(castOther.getId())))
                ...
                && ((this.getSlideOrder() == castOther.getSlideOrder())
                        || (this.getSlideOrder() != null && castOther.getSlideOrder() != null && this.getSlideOrder().equals(castOther.getSlideOrder())))
    ...
    public int hashCode() {
        ...
        result = 37 * result + (getSlideOrder() == null ? 0 : this.getSlideOrder().hashCode());
