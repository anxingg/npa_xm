...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="wpTrendList" filterBtn="true" pagination="true" fitColumns="true" actionUrl="postsController.do?trendDatagrid" idField="id" fit="true" queryMode="group" pageSize="20">
