...
public class FreemarkerUtil {
    ...
    /**
     * 创建 word 文档 必须先设置response导出配置，然后解析模版，否则会出问题
     * 
     * @throws IOException
     */
    public static void createFile(String templateName, String docFileName, Map<String, Object> rootMap, HttpServletRequest request, HttpServletResponse response, int fileType)
            throws IOException {
