...
public class DataGridUrl {
    ...
    public String toString() {
        return "DataGridUrl [url=" + url + ", title=" + title + ", icon=" + icon + ", value=" + value + ", width=" + width + ", height=" + height + ", type=" + type + ", isbtn="
                + isbtn + ", message=" + message + ", exp=" + exp + ", funname=" + funname + ", isRadio=" + isRadio + ", onclick=" + onclick + ", urlStyle=" + urlStyle
                + ", urlclass=" + urlclass + ", urlfont=" + urlfont + ", id=" + id + ", operationCode=" + operationCode + "]";
    }
