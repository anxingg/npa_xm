...
public class DataGridTag extends TagSupport {
     ...
     * @param urlclass
     */
    public void setOpenUrl(String url, String title, String width, String height, String exp, String operationCode, String openModel, String urlStyle, String urlclass,
            String urlfont, boolean inGroup) {
        DataGridUrl dataGridUrl = new DataGridUrl();
        dataGridUrl.setTitle(title);
        dataGridUrl.setUrl(url);
     ...
     * @param newColumn
     */
    public void setColumn(String title, String field, Integer width, Integer showLen, String rowspan, String colspan, String align, boolean sortable, boolean checkbox,
            String formatter, String formatterjs, boolean hidden, String replace, String treefield, boolean image, String imageSize, boolean query, String url, String funname,
            String arg, String queryMode, String dictionary, boolean popup, boolean frozenColumn, String extend,
            ...
            String filterType, boolean optsMenu
    ...
    public int doEndTag() throws JspException {
        ...
        // log.info("================================ DataGridTag 开始时间:"+sdf.format(new
        // Date())+"==============================");
        JspWriter out = null;
        try {
            ...
            // }
            // }
            // SysThemesEnum sysThemesEnum = SysThemesUtil.getSysTheme((HttpServletRequest)
        ...
        // log.info("=============================== DataGridTag 结束时间:"+sdf.format(new
        // Date())+"==============================");
        // log.info("================================ DataGridTag
        // 耗时:"+(end-start)+"ms==============================");
        return EVAL_PAGE;
    }
    ...
    public StringBuffer jqGrid() {
        ...
        if (hasQueryColum(columnList)) {
            ...
            sb.append(
                    "<div name=\"searchColums\" class=\"search-content\"><form name=\"" + name + "Form\" id=\"" + name + "Form\"></form></div><div class=\"col-sm-1 pull-right\">");
            ...
            for (DataGridColumn column : columnList) {
                if (column.isQuery()) {
                    ...
                    if (oConvertUtils.isNotEmpty(dictionary)) {
                            ...
                            if (dictionary.indexOf(",") > -1) {
                                        ...
                                        if (dictionaryList != null && !dictionaryList.isEmpty()) {
                                            for (Map<String, Object> map : dictionaryList) {
                                                if (map.containsKey(dictionaryArray[1]) && map.containsKey(dictionaryArray[2])) {
                                                    ...
                                                    sb.append(" <input type=\"radio\" value=\"" + map.get(dictionaryArray[1]) + "\" name=\"" + field
                                                            + "_radio\" onclick=\"javascrpt:$('#" + field + "_radio').val('" + map.get(dictionaryArray[1]) + "');\" />");
                                ...
                                if (typeList != null && !typeList.isEmpty()) {
                                    ...
                                    for (TSType type : typeList) {
                                        ...
                                        sb.append(" <input type=\"radio\" value=\"" + type.getTypecode() + "\" name=\"" + field + "_radio\" onclick=\"javascrpt:$('#" + field
                                                + "_radio').val('" + type.getTypecode() + "');\" />");
                            ...
                            if (dictionary.indexOf(",") > -1) {
                                        ...
                                        if (dictionaryList != null && !dictionaryList.isEmpty()) {
                                            for (Map<String, Object> map : dictionaryList) {
                                                if (map.containsKey(dictionaryArray[1]) && map.containsKey(dictionaryArray[2])) {
                                                    ...
                                                    sb.append(" <input type=\"checkbox\" onclick=\"javascript:if(this.checked)$('#" + field + "_checkbox').val($('#" + field
                                                            + "_checkbox').val()+'," + value + ",');else{$('#" + field + "_checkbox').val($('#" + field
                                                            + "_checkbox').val().replace('," + value + ",',''));}\" value=\"" + value + "\" name=\"" + field
                                ...
                                if (typeList != null && !typeList.isEmpty()) {
                                    ...
                                    for (TSType type : typeList) {
                                        ...
                                        sb.append(" <input type=\"checkbox\" onclick=\"javascript:if(this.checked)$('#" + field + "_checkbox').val($('#" + field
                                                + "_checkbox').val()+'," + typeCode + ",');else{$('#" + field + "_checkbox').val($('#" + field + "_checkbox').val().replace(',"
                                                + typeCode + ",',''));}\" value=\"" + typeCode + "\" name=\"" + field + "_checkbox\" class=\"" + field + "_checkbox\" />");
                                        sb.append(MutiLangUtil.getLang(type.getTypename()));
                                    }
                                }
                            }
                        ...
                        if (showMode != null && "radio".equals(showMode)) {
                            ...
                            for (String string : test) {
                                ...
                                if (column.getDefaultVal() != null && column.getDefaultVal().trim().equals(value)) {
                                    sb.append(" <input type=\"radio\" value=\"" + value + "\" name=\"" + field + "_radio\" onclick=\"javascrpt:$('#" + field + "_radio').val('"
                                            + value + "');\" checked=\"checked\" />" + text);
                                    sb.append(" <script type=\"text/javascript\">");
                            ...
                            for (String string : test) {
                                ...
                                if (column.getDefaultVal() != null && column.getDefaultVal().trim().equals(value)) {
                                    sb.append(" <input type=\"checkbox\" onclick=\"javascript:if(this.checked)$('#" + field + "_checkbox').val($('#" + field
                                            + "_checkbox').val()+'," + value + ",');else{$('#" + field + "_checkbox').val($('#" + field + "_checkbox').val().replace('," + value
                                            + ",',''));}\" value=\"" + value + "\" name=\"" + field + "_checkbox\" class=\"" + field + "_checkbox\" checked=\"checked\" />" + text);
                                    sb.append(" <script type=\"text/javascript\">");
                                    ...
                                    sb.append(" <input type=\"checkbox\" onclick=\"javascript:if(this.checked)$('#" + field + "_checkbox').val($('#" + field
                                            + "_checkbox').val()+'," + value + ",');else{$('#" + field + "_checkbox').val($('#" + field + "_checkbox').val().replace('," + value
                                            + ",',''));}\" value=\"" + value + "\" name=\"" + field + "_checkbox\" class=\"" + field + "_checkbox\" />" + text);
                                }
                            }
                        } else {
                        ...
                        sb.append("<input  onkeypress=\"EnterPress(event)\" onkeydown=\"EnterPress()\"  type=\"text\" name=\"" + column.getField().replaceAll("_", "\\.") + "\"  "
                                + extendAttribute(column.getExtend()) + " ");
        ...
        // String width = toolBar.getWidth().contains("%")?"'"+toolBar.getWidth()+"'":toolBar.getWidth();
        // String height =
        // toolBar.getHeight().contains("%")?"'"+toolBar.getHeight()+"'":toolBar.getHeight();
        // sb.append(width+","+height+")");
        // }
        // sb.append("}");
        ...
        sb.append("$(\'#" + name
                + "tb\').find('*').each(function(){ if($(this).attr('name') != undefined && $(this).val() != ''){queryParams += \"&\" + $(this).attr('name') + \"=\" + $(this).val();}});");
    ...
    public StringBuffer datatables() {
        ...
        sb.append("\"oLanguage\" : {" + "\"sLengthMenu\" : \" _MENU_ 条记录\"," + "\"sZeroRecords\" : \"没有检索到数据\"," + "\"sInfo\" : \"第 _START_ 至 _END_ 条数据 共 _TOTAL_ 条\","
                + "\"sInfoEmtpy\" : \"没有数据\"," + "\"sProcessing\" : \"正在加载数据...\"," + "\"sSearch\" : \"搜索\"," + "\"oPaginate\" : {" + "\"sFirst\" : \"首页\","
                + "\"sPrevious\" : \"前页\", " + "\"sNext\" : \"后页\"," + "\"sLast\" : \"尾页\"" + "}" + "},"); // 汉化
    ...
    public String toString() {
        ...
        key.append("DataGridTag [fields=").append(fields).append(",searchFields=").append(searchFields).append(",name=").append(name).append(",title=").append(title)
                .append(",idField=").append(idField).append(",treegrid=").append(treegrid).append(",actionUrl=").append(actionUrl).append(",sortName=").append(sortName)
                .append(",queryMode=").append(queryMode).append(",entityName=").append(entityName).append(", cssTheme=").append(cssTheme).append(",treeField=").append(treeField)
                .append(",btnCls=").append(btnCls).append(",queryBuilder=").append(queryBuilder).append(",collapsible=").append(collapsible).append(",superQuery=")
                .append(superQuery).append(",complexSuperQuery=").append(complexSuperQuery);
        key.append(",urlList=[");
        ...
        key.append(",sysTheme=").append(SysThemesUtil.getSysTheme(ContextHolderUtils.getRequest()).getStyle())
                .append(",brower_type=" + ContextHolderUtils.getSession().getAttribute("brower_type")).append("]");
        return key.toString();
    };
    ...
    public StringBuffer end() {
            ...
            if (subtableids != null) {
                for (String ss : subtableids) {
                    ...
                    for (Map<String, Object> map : subfieldlist) {
                        ...
                        // if(map.get("main_field")!=null && map.get("main_field").toString().length()>0 &&
                        // "".equals(linkid)){
                    ...
                    sb.append("var " + submap.getHead().getTableName() + "durl = 'cgAutoListController.do?datagrid&configId=" + submap.getHead().getTableName() + "&" + linkid
                            + "='+row.id+'&field=" + subfield + "&page=1&rows=100';");
                    sb.append("var " + submap.getHead().getTableName() + "tablelines = $(this).datagrid('getRowDetail',index).find('table." + submap.getHead().getTableName()
                            + "tablelines');");
        ...
        if (oConvertUtils.isNotEmpty(complexSuperQuery)) {
            sb.append("function " + name
                    + "SuperQuery(queryCode){if(typeof(windowapi)=='undefined'){$.dialog({content:'url:superQueryMainController.do?dialog&code='+queryCode+'&tableName=" + name
                    + "',width:880,height:400,zIndex:getzIndex(),title:'高级查询构造器',cache:false,lock:true})}else{$.dialog({content:'url:superQueryMainController.do?dialog&code='+queryCode+'&tableName="
                    + name + "',width:880,height:400,zIndex:getzIndex(),title:title,cache:false,lock:true,parent:windowapi})}};");
        }
        // 过滤操作
        getFilterFields(sb);
        ...
        if (hasQueryColum(columnList) && "group".equals(getQueryMode())) {
            ...
            sb.append(
                    "<span><img style=\"margin-top:-3px;vertical-align:middle;\" src=\"plug-in/easyui/themes/icons/ti.png\"  title=\"提示：模糊查询通配符: *，多个关键字用半角逗号 ',' 隔开！\" alt=\"提示：模糊查询通配符: *，多个关键字用半角逗号 ',' 隔开！\" /></span>");
        ...
        if (toolBarList.size() > 0) {
            ...
            if (hasMore) {
                ...
                sb.append("</ul></div>");
                // sb.append("<div class='btn-group'><button data-toggle='dropdown' class='btn btn-default
                // dropdown-toggle'>操作<span class='caret'></span> </button><ul class='dropdown-menu'><li><a
                // href='buttons.html#'>置顶</a></li><li><a href='buttons.html#' class='font-bold'>修改</a></li><li><a
                // href='buttons.html#'>禁用</a></li><li class='divider'></li> <li><a href='buttons.html#'>删除</a></li>
                // </ul> </div>");
            }
        ...
        if ("single".equals(getQueryMode()) && hasQueryColum(columnList)) {// 如果表单是单查询
            ...
            sb.append("<input id=\"" + name + "searchbox\" class=\"easyui-searchbox\"  data-options=\"searcher:" + name
                    + StringUtil.replaceAll("searchbox,prompt:\'{0}\',menu:\'#", "{0}", MutiLangUtil.getLang("common.please.input.keyword")) + name + "mm\'\"></input>");
            ...
            if (btnCls != null && !btnCls.equals("easyui")) {// 自定以样式 bootstrap按钮样式
                if (btnCls.indexOf("bootstrap") == 0) {
                    ...
                    if (superQuery) {
                        sb.append("<a href=\"#\" class=\"" + btnCls + "\" onclick=\"queryBuilder('"
                                + StringUtil.replaceAll("')\">{0}</a>", "{0}", MutiLangUtil.getLang("common.superquery")));
                    }
                }
            } else {// 默认使用easyUI按钮样式
                if (superQuery) {
        ...
        if ("group".equals(getQueryMode()) && hasQueryColum(columnList)) {// 如果表单是组合查询
            ...
            if (btnCls != null && !btnCls.equals("easyui")) {// 自定以样式 bootstrap按钮样式
                if (btnCls.indexOf("bootstrap") == 0) {
                    ...
                    sb.append(
                            "<a href=\"#\" class=\"" + btnCls + "\" onclick=\"" + name + StringUtil.replaceAll("search()\">{0}</a>", "{0}", MutiLangUtil.getLang("common.query")));
                    sb.append("<a href=\"#\" class=\"" + btnCls + "\" onclick=\"searchReset('" + name
                            + StringUtil.replaceAll("')\">{0}</a>", "{0}", MutiLangUtil.getLang("common.reset")));
                    if (queryBuilder) {
                        sb.append("<a href=\"#\" class=\"" + btnCls + "\" onclick=\"queryBuilder('"
                                + StringUtil.replaceAll("')\">{0}</a>", "{0}", MutiLangUtil.getLang("common.querybuilder")));
                    }
                    ...
                    if (oConvertUtils.isNotEmpty(complexSuperQuery)) {
                        ...
                        sb.append("<a href=\"#\" class=\"" + btnCls + "\" onclick=\"" + name + "SuperQuery('" + complexSuperQuery + "')\">"
                                + MutiLangUtil.getLang("common.advancedQuery") + "</a>");
                ...
                sb.append("<a href=\"#\" class=\"easyui-linkbutton\" iconCls=\"icon-search\" onclick=\"" + name
                        + StringUtil.replaceAll("search()\">{0}</a>", "{0}", MutiLangUtil.getLang("common.query")));
                ...
                if (oConvertUtils.isNotEmpty(complexSuperQuery)) {
                    ...
                    sb.append("<a href=\"#\" class=\"easyui-linkbutton\" iconCls=\"icon-search\" onclick=\"" + name + "SuperQuery('" + complexSuperQuery + "')\">"
                            + MutiLangUtil.getLang("common.advancedQuery") + "</a>");
        ...
        if ("group".equals(getQueryMode())) {
            ...
            for (DataGridColumn col : columnList) {
                if (col.isQuery()) {
                    ...
                    if (i == 0) {
                        sb.append(
                                "<span style=\"vertical-align:middle;display:-moz-inline-box;display:inline-block;width:74px;text-align:right;text-overflow:ellipsis;-o-text-overflow:ellipsis; overflow: hidden;white-space:nowrap; \" title=\""
                                        + col.getTitle() + "\">" + "&nbsp;&nbsp;&nbsp;" + col.getTitle() + "：" + (col.getTitle().length() < 4 ? "&nbsp;&nbsp;&nbsp;" : "")
                                        + "</span>");
                    } else {
                        sb.append(
                                "<span style=\"vertical-align:middle;display:-moz-inline-box;display:inline-block;width: 90px;text-align:right;text-overflow:ellipsis;-o-text-overflow:ellipsis; overflow: hidden;white-space:nowrap; \" title=\""
                    ...
                    if ("single".equals(col.getQueryMode())) {
                        if (!StringUtil.isEmpty(col.getReplace())) {
                            ...
                            if (col.getDictionary().contains(",") && col.isPopup()) {
                                ...
                                // "+col.getDictCondition();
                                // }else{
                                // sql = "select " + dic[1] + " as field," + dic[2]+ " as text from " + dic[0];
                                // }

                                // System.out.println(dic[0]+"--"+dic[1]+"--"+dic[2]);
                                // <input type="text" name="order_code" style="width: 100px" class="searchbox-inputtext" value=""
                                ...
                                if (col.getDefaultVal() != null && !col.getDefaultVal().trim().equals("")) {
                                    sb.append("<input type=\"text\" name=\"" + col.getField().replaceAll("_", "\\.")
                                            + "\" style=\"width: 120px\" class=\"searchbox-inputtext\" value=\"\" onClick=\"popupClick(this,'" + dic[2].replaceAll("@", ",") + "','"
                                ...
                                if (null != showMode && "radio".equals(showMode)) {
                                    ...
                                    for (Map<String, Object> map : list) { //
                                        ...
                                        if (col.getDefaultVal() != null && col.getDefaultVal().trim().equals(map.get("field"))) {
                                            sb.append(" <input type=\"radio\" name=\"" + field + "_radio\" onclick=\"javascrpt:$('#" + field + "_radio').val('" + map.get("field")
                                                    + "');\" value=\"" + map.get("field") + "\" checked=\"checked\" />");
                                            sb.append(" <script type=\"text/javascript\">");
                                    ...
                                    for (Map<String, Object> map : list) { //
                                        if (col.getDefaultVal() != null && col.getDefaultVal().trim().equals(map.get("field"))) {
                                            sb.append(" <input type=\"checkbox\" onclick=\"javascript:if(this.checked)$('#" + field + "_checkbox').val($('#" + field
                                                    + "_checkbox').val()+'," + map.get("field") + ",');else{$('#" + field + "_checkbox').val($('#" + field
                                                    + "_checkbox').val().replace('," + map.get("field") + ",',''));}\" value=\"" + map.get("field") + "\" name=\"" + field
                                ...
                                if (null != showMode && "radio".equals(showMode)) {
                                    if (types != null) {
                                        ...
                                        for (TSType type : types) {
                                            ...
                                            if (col.getDefaultVal() != null && col.getDefaultVal().trim().equals(typeCode)) {
                                                sb.append(" <input type=\"radio\" value=\"" + typeCode + "\" name=\"" + field + "_radio\" onclick=\"javascrpt:#('#" + field
                                                        + "_radio').val('" + typeCode + "');\" checked=\"checked\" />");
                                                sb.append(" <script type=\"text/javascript\">");
                                    ...
                                    if (types != null) {
                                        ...
                                        for (TSType type : types) {
                                            ...
                                            if (col.getDefaultVal() != null && col.getDefaultVal().trim().equals(typeCode)) {
                                                sb.append(" <input type=\"checkbox\" onclick=\"javascript:if(this.checked)$('#" + field + "_checkbox').val($('#" + field
                                                        + "_checkbox').val()+'," + typeCode + ",');else{$('#" + field + "_checkbox').val($('#" + field
                                                        + "_checkbox').val().replace('," + typeCode + ",',''));}\" value=\"" + typeCode + "\" name=\"" + field
                                                        + "_checkbox\" class=\"" + field + "_checkbox\" checked=\"checked\" />");
                                                sb.append(" <script type=\"text/javascript\">");
                            ...
                            // sb.append("<input onkeypress=\"EnterPress(event)\" onkeydown=\"EnterPress()\" type=\"text\"
                            // name=\""+col.getField().replaceAll("_","\\.")+"\" "+extendAttribute(col.getExtend())+"
                        ...
                        if (this.DATE_FORMATTER.equals(col.getFormatter())) {
                            sb.append("<input type=\"text\" name=\"" + col.getField() + "_begin\"  style=\"width: 100px\" " + extendAttribute(col.getExtend())
                                    + " class=\"Wdate\" onClick=\"WdatePicker()\"/>");
                            sb.append("<span style=\"display:-moz-inline-box;display:inline-block;width: 8px;text-align:right;\">~</span>");
                            sb.append("<input type=\"text\" name=\"" + col.getField() + "_end\"  style=\"width: 100px\" " + extendAttribute(col.getExtend())
                                    + " class=\"Wdate\" onClick=\"WdatePicker()\"/>");
                        } else if (this.DATETIME_FORMATTER.equals(col.getFormatter())) {
                            sb.append("<input type=\"text\" name=\"" + col.getField() + "_begin\"  style=\"width: 140px\" " + extendAttribute(col.getExtend())
                                    + " class=\"Wdate\" onClick=\"WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})\"/>");
                            sb.append("<span style=\"display:-moz-inline-box;display:inline-block;width: 8px;text-align:right;\">~</span>");
                            sb.append("<input type=\"text\" name=\"" + col.getField() + "_end\"  style=\"width: 140px\" " + extendAttribute(col.getExtend())
                                    + " class=\"Wdate\" onClick=\"WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})\"/>");
                        } else {
                            sb.append("<input type=\"text\" name=\"" + col.getField() + "_begin\"  style=\"width: 100px\" " + extendAttribute(col.getExtend())
                                    + " class=\"inuptxt\"/>");
        ...
        for (DataGridUrl dataGridUrl : list) {
            if (!dataGridUrl.isInGroup()) {
                ...
                if (OptTypeDirection.Confirm.equals(dataGridUrl.getType())) {
                    ...
                    if (!StringUtil.isEmpty(dataGridUrl.getUrlclass())) {
                        sb.append("href+=\"<a href=\'#\'  " + urlclass.toString() + "  onclick=confirm(\'" + url + "\',\'" + dataGridUrl.getMessage() + "\',\'" + name + "\')"
                                + style.toString() + "> " + urlfont.toString() + " \";");
                    } else {
                ...
                if (OptTypeDirection.Del.equals(dataGridUrl.getType())) {
                    if (!StringUtil.isEmpty(dataGridUrl.getUrlclass())) {// 倘若urlclass不为空，则去掉链接前面的"[";
                        sb.append("href+=\"<a href=\'#\'  " + urlclass.toString() + "  onclick=delObj(\'" + url + "\',\'" + name + "\')" + style.toString() + "> "
                                + urlfont.toString() + " \";");
                    } else {
                ...
                if (OptTypeDirection.Fun.equals(dataGridUrl.getType())) {
                    ...
                    if (!StringUtil.isEmpty(dataGridUrl.getUrlclass())) {// 倘若urlclass不为空，则去掉链接前面的"[";
                        sb.append(
                                "href+=\"<a href=\'#\'  " + urlclass.toString() + "  onclick=" + name + "(" + parmars + ")" + style.toString() + "> " + urlfont.toString() + "\";");
                    } else {
                ...
                if (OptTypeDirection.OpenWin.equals(dataGridUrl.getType())) {
                    ...
                    if (!StringUtil.isEmpty(dataGridUrl.getUrlclass())) {// 倘若urlclass不为空，则去掉链接前面的"[";
                        sb.append("href+=\"<a href=\'#\' " + urlclass.toString() + " onclick=openwindow('" + dataGridUrl.getTitle() + "','" + url + "','" + name + "',"
                                + dataGridUrl.getWidth() + "," + dataGridUrl.getHeight() + ")" + style.toString() + ">" + urlfont.toString() + "\";");
                    } else {
                        sb.append("href+=\"[<a href=\'#\' onclick=openwindow('" + dataGridUrl.getTitle() + "','" + url + "','" + name + "'," + dataGridUrl.getWidth() + ","
                                + dataGridUrl.getHeight() + ")" + style.toString() + ">\";");
                    }
                ...
                if (OptTypeDirection.Deff.equals(dataGridUrl.getType())) {
                    ...
                    if (!StringUtil.isEmpty(dataGridUrl.getUrlclass())) {
                        sb.append("href+=\"<a href=\'" + url + "' " + urlclass.toString() + " title=\'" + dataGridUrl.getTitle() + "\'" + style.toString() + ">"
                                + urlfont.toString() + "\";");
                    } else {
                ...
                if (OptTypeDirection.OpenTab.equals(dataGridUrl.getType())) {
                    ...
                    if (!StringUtil.isEmpty(dataGridUrl.getUrlclass())) {// 倘若urlclass不为空，则去掉链接前面的"[";
                        sb.append("href+=\"<a href=\'#\' " + urlclass.toString() + " onclick=addOneTab('" + dataGridUrl.getTitle() + "','" + url + "') " + style.toString() + ">"
                                + urlfont.toString() + "\";");
                    } else {
                ...
                if (column.getFormatterjs() != null) {
                    ...
                    if (column.isImage()) {
                        if (column.getImageSize() != null) {// 自定义显示图片
                            ...
                            sb.append(",formatter:function(value,rec,index){");
                            sb.append(
                                    " return '<img width=\"" + tld[0] + "\" height=\"" + tld[1] + "\" border=\"0\" " + " onMouseOver=\"tipImg(this)\" onMouseOut=\"moveTipImg()\" "
                        ...
                        sb.append(
                                " html = '<a class=\"ace_button fa fa-download\" style=\"padding:3px 5px;\" target=\"_blank\" href=\"systemController/downloadFile.do?filePath='+value+'\">"
                        ...
                        if (column.getDictionary() != null && column.getDictionary().contains(",") && column.getIsAjaxDict()) {
                            sb.append(",formatter:function(value,rec,index){");
                            sb.append("var rtn = \"<span name=\\\"ajaxDict\\\" dictionary=\\\"" + column.getDictionary() + "\\\" dictCondition=\\\""
                                    + (column.getDictCondition() == null ? "" : column.getDictCondition()) + "\\\" popup=\\\"" + column.isPopup()
    ...
    private String getAutoSpan(String filed, String extend) {
        ...
        nsb.append("$(\"#" + getEntityName() + "_" + id + "\").val(row['" + filed + "']);}); });").append("</script>")
                .append("<input class=\"inuptxt\" type=\"text\" id=\"" + getEntityName() + "_" + id + "\" name=\"" + filed + "\"  " + extend
                        + StringUtil.replace(" nullmsg=\"\" errormsg=\"{0}\"/>", "{0}", MutiLangUtil.getLang("input.error")));
        return nsb.toString();
    }
    ...
    public StringBuffer aceStyleTable() {
        ...
        if ("group".equals(getQueryMode()) && hasQueryColum(columnList)) {// 如果表单是组合查询
            ...
            if (btnCls != null && !btnCls.equals("easyui")) {// 自定以样式 bootstrap按钮样式
                ...
                sb.append("<a href=\"#\" class=\"button\" iconCls=\"icon-search\" onclick=\"" + name
                        + StringUtil.replaceAll("search()\">{0}</a>", "{0}", MutiLangUtil.getLang("common.query")));
                ...
                if (oConvertUtils.isNotEmpty(complexSuperQuery)) {
                    ...
                    sb.append("<a href=\"#\" class=\"button\" iconCls=\"icon-search\" onclick=\"" + name + "SuperQuery('" + complexSuperQuery + "')\">"
                            + MutiLangUtil.getLang("common.advancedQuery") + "</a>");
            ...
            for (DataGridColumn col : columnList) {
                if (col.isQuery()) {
                    sb.append("<div data-options=\"name:\'" + col.getField().replaceAll("_", "\\.") + "\',iconCls:\'icon-ok\' " + extendAttribute(col.getExtend()) + " \">"
                            + col.getTitle() + "</div>  ");
                }
            }
            sb.append("</div>");
    ...
    private void addQueryBuilder(StringBuffer sb, String buttonSytle) {
        ...
        appendLine(sb,
                "<div id=\"" + name + "_qbwin\" class=\"easyui-window\" data-options=\"closed:true,title:'&nbsp;&nbsp;高级查询构造器'\" style=\"width:600px;height:370px;padding:0px\">");
        appendLine(sb, "	<div class=\"easyui-layout\" data-options=\"fit:true\">");
        appendLine(sb,
                "		<div data-options=\"region:'east',split:true\" style=\"width:130px;overflow: hidden;\"><div data-options=\"fit:true\" class=\"easyui-accordion\" style=\"width:120px;height:300px;\">");
        ...
        if (btnCls != null && !btnCls.equals("easyui")) {
            ...
            appendLine(sb, "<a class=\"" + buttonSytle + "\" data-options=\"iconCls:'icon-cancel'\" href=\"javascript:void(0)\" onclick=\"javascript:$('#" + name
                    + "_qbwin').window('close')\">取消</a>");
        }
        ...
        // 已在baseTag中引入
        // appendLine(sb,"<script type=\"text/javascript\" src=\"plug-in/jquery/jquery.cookie.js\"
        // ></script>");
    ...
    private void getOptsMenuUrl(StringBuffer sb) {
        ...
        if (oConvertUtils.isNotEmpty(groupString.toString())) {
            sb.append(
                    "href+='<div style=\"left:40px;top:-1px\" class=\"opts_menu_container\"><div class=\"opts_menu_btn btn-menu\"><i class=\"fa fa-caret-right\" style=\"margin-top:1px;\"></i></div>';");
            sb.append(
                    "href+='<div style=\"clear: both;\"></div><div style=\"\" class=\"opts-menus-parent pp_menu_box\"><div class=\"opts_menu_box opts-menus-auto\" style=\"left:18px;\">';");
    ...
    protected void getOptUrl(StringBuffer sb, boolean noReturn, boolean initGroup) {
        ...
        for (DataGridUrl dataGridUrl : list) {
            ...
            if (OptTypeDirection.Fun.equals(dataGridUrl.getType())) {
                String name = TagUtil.getFunction(dataGridUrl.getFunname());
                String parmars = TagUtil.getFunParams(dataGridUrl.getFunname());
                sb.append("href+=\"<a href=\'#\' title='" + dataGridUrl.getTitle() + "' " + urlclass.toString() + " onclick=" + name + "(" + parmars + ")" + style.toString() + ">"
                        + urlfont.toString() + "\";");
            }
            if (OptTypeDirection.OpenWin.equals(dataGridUrl.getType())) {
                ...
                sb.append("href+=\"<a href=\'####\' title='" + dataGridUrl.getTitle() + "' " + urlclass.toString() + " onclick=" + funname + "('" + dataGridUrl.getTitle() + "','"
                        + url + "','" + name + "'," + dgFormWidth + "," + dgFormHeight + ")" + style.toString() + ">" + urlfont.toString() + "\";");
            }
            sb.append("href+=\"" + "" + "</a>&nbsp;\";");
            if (StringUtil.isNotEmpty(exp)) {
                for (int i = 0; i < exp.split("&&").length; i++) {
    ...
    private void addAdvancedQuery(StringBuffer sb, String buttonSytle) {
        ...
        /*
         * FreemarkerHelper free = new FreemarkerHelper(); Map<String, Object> mainConfig = new
         * HashMap<String, Object>(); mainConfig.put("queryCode", complexSuperQuery);
         * mainConfig.put("tableName", name); String complexSuperQuery =
         * free.parseTemplate("/org/jeecgframework/tag/ftl/complexSuperQuery.ftl", mainConfig);
