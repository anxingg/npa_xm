 ...
 * 用户选择弹出组件
 * 
 * @author: wangkun @date： 日期：2015-3-27
 * @version 1.0
 */
public class UserSelectTag extends TagSupport {
    ...
    public StringBuffer end() {
        ...
        sb.append("<input class=\"inuptxt\" readonly=\"" + readonly + "\" type=\"text\" id=\"" + selectedNamesInputId + "\" name=\"" + selectedNamesInputId + "\" style=\"width: "
                + inputWidth + "\" onclick=\"openUserSelect()\" ");
        ...
        sb.append("    $.dialog({content: 'url:userController.do?userSelect', zIndex: getzIndex(), title: '" + title + "', lock: true, width: '" + windowWidth + "', height: '"
                + windowHeight + "', opacity: 0.4, button: [");
