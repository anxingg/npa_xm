...
public class FormValidationTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            /*
             * // if(cssTheme==null){//手工设置值优先 Cookie[] cookies = ((HttpServletRequest) super.pageContext
             * .getRequest()).getCookies(); for (Cookie cookie : cookies) { if (cookie == null ||
             * StringUtils.isEmpty(cookie.getName())) { continue; } if
             * (cookie.getName().equalsIgnoreCase("JEECGCSSTHEME")) { cssTheme = cookie.getValue(); } } // }
        ...
        // "==============================");
        // logger.debug("===============Form=====doStartTag=================耗时:" + (end - start) +
        // "ms==============================");
    ...
    public int doEndTag() throws JspException {
        ...
        try {
            ...
            if (layout.equals("div")) {
                ...
                // sb.append("<link rel=\"stylesheet\" href=\"plug-in/Validform/css/"+cssTheme+"/divfrom.css\"
                // type=\"text/css\"/>");
                // }else{
            ...
            // if("metro".equals(cssTheme)){
            // sb.append("<link rel=\"stylesheet\" href=\"plug-in/Validform/css/"+cssTheme+"/style.css\"
            // type=\"text/css\"/>");
            // sb.append("<link rel=\"stylesheet\" href=\"plug-in/Validform/css/"+cssTheme+"/tablefrom.css\"
            // type=\"text/css\"/>");
            // }else{
        ...
        // "==============================");
        // logger.debug("===============Form=====doEndTag=================耗时:" + (end - start) +
        // "ms==============================");
        return EVAL_PAGE;
    }
    ...
    public String toString() {
        ...
        builder.append("FormValidationTag [formid=").append(formid).append(", refresh=").append(refresh).append(", callback=").append(callback).append(", beforeSubmit=")
                .append(beforeSubmit).append(", btnsub=").append(btnsub).append(", btnreset=").append(btnreset).append(", layout=").append(layout).append(", usePlugin=")
                .append(usePlugin).append(", dialog=").append(dialog).append(", action=").append(action).append(", tabtitle=").append(tabtitle).append(", tiptype=").append(tiptype)
                .append(", styleClass=").append(styleClass).append(", cssTheme=").append(cssTheme).append(",sysTheme=")
