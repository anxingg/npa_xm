...
public class GraphReportServiceImpl extends CommonServiceImpl implements GraphReportServiceI {
    ...
    public Map<String, Object> queryCgReportConfig(String reportId) {
        ...
        List<Map<String, Object>> itemsM =
                jdbcDao.findForJdbc("SELECT * from jform_graphreport_item where cgreport_head_id=? order by order_num asc", new Object[] {mainM.get("id")});
