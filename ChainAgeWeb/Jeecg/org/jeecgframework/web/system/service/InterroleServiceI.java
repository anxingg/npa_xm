...
public interface InterroleServiceI extends CommonService {
     ...
     *
     * @Title: getOperationCodesByRoleIdAndruleDataId @Description: TODO @param @param
     * roleId @param @param functionId @param @return 设定文件 @return Set<String> 返回类型 @throws
     */
