...
public class TSDictTableConfigServiceImpl extends CommonServiceImpl implements TSDictTableConfigServiceI {
    ...
    public boolean checkDictAuth(String dictionary, String dictCondition) {
        ...
        /*
         * String dictConditionPram = dictCondition; if(dictConditionPram!=null){ dictConditionPram =
         * StringUtils.deleteWhitespace(dictConditionPram); }else{ dictConditionPram = ""; } String
         * dicString = ""; for(TSDictTableConfigEntity config:list){ dicString = config.getDictCondition();
         * if(dicString!=null){ dicString = StringUtils.deleteWhitespace(dicString); }else{ dicString = "";
         * } if(dicString.equals(dictConditionPram)){ return true; } }
         */
