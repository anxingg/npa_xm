...
public class TSSmsSqlController extends BaseController {
    ...
    // public void exportXls(TSSmsSqlEntity tSSmsSql,HttpServletRequest request,HttpServletResponse
    // response
    // , DataGrid dataGrid) {
    ...
    // CriteriaQuery cq = new CriteriaQuery(TSSmsSqlEntity.class, dataGrid);
    // org.jeecgframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tSSmsSql,
    // request.getParameterMap());
    //
    // List<TSSmsSqlEntity> tSSmsSqls = this.systemService.getListByCriteriaQuery(cq,false);
    // workbook = ExcelExportUtil.exportExcel(new ExportParams("业务SQL表列表",
    ...
    // public void exportXlsByT(TSSmsSqlEntity tSSmsSql,HttpServletRequest request,HttpServletResponse
    // response
    // , DataGrid dataGrid) {
    // response.setContentType("application/vnd.ms-excel");
    // String codedFileName = null;
