...
public class TSSmsTemplateController extends BaseController {
    ...
    // public void exportXls(TSSmsTemplateEntity tSSmsTemplate,HttpServletRequest
    ...
    // CriteriaQuery cq = new CriteriaQuery(TSSmsTemplateEntity.class, dataGrid);
    // org.jeecgframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tSSmsTemplate,
    // request.getParameterMap());
    //
    // List<TSSmsTemplateEntity> tSSmsTemplates =
    // this.tSSmsTemplateService.getListByCriteriaQuery(cq,false);
    // workbook = ExcelExportUtil.exportExcel(new ExportParams("消息模本表列表",
    ...
    // public void exportXlsByT(TSSmsTemplateEntity tSSmsTemplate,HttpServletRequest
    // request,HttpServletResponse response
    // , DataGrid dataGrid) {
    // response.setContentType("application/vnd.ms-excel");
    // String codedFileName = null;
