...
public class TSSmsTemplateSqlController extends BaseController {
    ...
    // public void exportXls(TSSmsTemplateSqlEntity tSSmsTemplateSql,HttpServletRequest
    ...
    // CriteriaQuery cq = new CriteriaQuery(TSSmsTemplateSqlEntity.class, dataGrid);
    // org.jeecgframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tSSmsTemplateSql,
    // request.getParameterMap());
    //
    // List<TSSmsTemplateSqlEntity> tSSmsTemplateSqls =
    // this.tSSmsTemplateSqlService.getListByCriteriaQuery(cq,false);
    // workbook = ExcelExportUtil.exportExcel(new ExportParams("消息模板_业务SQL配置表列表",
    ...
    // public void exportXlsByT(TSSmsTemplateSqlEntity tSSmsTemplateSql,HttpServletRequest
    // request,HttpServletResponse response
    // , DataGrid dataGrid) {
    // response.setContentType("application/vnd.ms-excel");
    // String codedFileName = null;
