...
public class TuiSongMsgUtil {
     ...
     *
     * @param code 模板CODE @param map 模板数据源 @param sentFrom 发送人 @param sentTo 发送给谁 @return 发送结果“success”
     * 发送成功 @throws
     */
     ...
     *
     * @param @param msgType 消息类型 @param @param code 业务配置CODE @param @param map 数据参数 @param @param
     * sentTo 发送给谁 @param @return 发送结果 “success” 发送成功 @throws
     */
     ...
     *
     * @Title: getTSSmsServiceInstance @Description: TODO @param @return 设定文件 @return TSSmsServiceI
     * 返回类型 @throws
     */
     ...
     *
     * @Title: getSearchSql @Description: TODO @param @param templateSql @param @param
     ...
     *
     * @Title: getTemplateServiceSql @Description: TODO @param @param sqlId @param @return 设定文件 @return
     * String 返回类型 @throws
     */
     ...
     *
     * @Title: getTemplateContent @Description: TODO @param @param templateId @param @return
     ...
     *
     * @Title: getTssmsTemplateSqlInstance @Description: TODO @param @return 设定文件 @return
     * TSSmsTemplateSqlServiceI 返回类型 @throws
     */
     ...
     *
     * @Title: getTssmsTemplateInstance @Description: TODO @param @return 设定文件 @return
     * TSSmsTemplateServiceI 返回类型 @throws
     */
     ...
     *
     * @Title: getTSSmsSqlInstance @Description: TODO @param @return 设定文件 @return TSSmsSqlServiceI
     * 返回类型 @throws
     */
