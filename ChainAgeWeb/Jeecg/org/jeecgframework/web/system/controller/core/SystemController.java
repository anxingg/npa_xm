...
public class SystemController extends BaseController {
    ...
    // @ResponseBody
    // public List<ComboTree> typeGroupTree(HttpServletRequest request, HttpServletResponse response,
    // DataGrid dataGrid) {
    ...
    // public void showOrDownByurl(HttpServletResponse response,HttpServletRequest request) throws
    // Exception{
    // String flag=request.getParameter("down");//是否下载否则展示图片
    // String dbpath = request.getParameter("dbPath");
