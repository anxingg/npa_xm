...
public class DepartAuthGroupController extends BaseController {
    ...
    private void recursiveGroup(List<Map<String, Object>> dataList, List<Map<String, Object>> departAuthGroupList, List<Map<String, Object>> chkDepartAuthGroupList, String value) {
    ...
    public AjaxJson updateDepartAuthority(HttpServletRequest request) {
        ...
        try {
            ...
            List<TSDepartAuthgFunctionRelEntity> functionGroupList =
                    systemService.findByProperty(TSDepartAuthgFunctionRelEntity.class, "tsDepartAuthGroup.id", functionGroup.getId());
     ...
     * @param map 旧的权限列表
     */
    private void updateCompare(Set<String> set, TSDepartAuthGroupEntity functionGroup, Map<String, TSDepartAuthgFunctionRelEntity> map) {
     ...
     * @param map 旧的权限列表
     */
    private void updateRoleCompare(Set<String> set, TSRole role, Map<String, TSRoleFunction> map) {
     ...
     * @param map 旧的角色信息表
     */
    private void updateGroupUser(Set<String> set, String userId, Map<String, TSRoleUser> map) {
