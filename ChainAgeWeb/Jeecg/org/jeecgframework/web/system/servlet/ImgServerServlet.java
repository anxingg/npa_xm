...
public class ImgServerServlet extends HttpServlet {
    ...
    /**
     * 图片本地访问： 服务化地址根路径 举例： http://localhost:8080/jeecg/img/service/20170519/profile_small.jpg 格式：
     * {项目访问地址}/img/server/{图片相对路径}
     */
    private static final String WEB_UPLOAD_BASE_PATH = "img/server/";
    /**
     * 举例： http://localhost:8080/jeecg/img-online/service/jform00001/images/jform00001.jpg 格式：
     * {项目访问地址}/img-online/server/{图片相对路径}
     */
    ...
    protected long getLastModified(HttpServletRequest request) {
        ...
        /*
         * 将资源的路径从工程的路径转换到真实的路径 String url = request.getRequestURI(); String imgPath =
         * request.getRequestURI().substring(url.indexOf(WEB_UPLOAD_BASE_PATH),url.length()).replace(
         * WEB_UPLOAD_BASE_PATH,""); String localPath = ResourceUtil.getConfigByName("webUploadpath");
         * String imgurl = localPath + File.separator + imgPath; // System.out.println(imgurl); // String
         * path = this.getServletContext().getRealPath(imgurl);
         * 
         * File file = new File(imgurl); System.out.println(file.lastModified()); return
         * file.lastModified();
         */
