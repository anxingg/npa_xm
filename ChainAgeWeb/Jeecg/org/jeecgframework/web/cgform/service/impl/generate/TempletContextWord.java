...
public class TempletContextWord {
    ...
    public String autoFormGenerateHtml(String tableName, String id, String mode) {
        ...
        // html = html.replace("<html xmlns:m=\"http://schemas.microsoft.com/office/2004/12/omml\">", "<%@
        // page language=\"java\" import=\"java.util.*\" contentType=\"text/html; charset=UTF-8\"
        // pageEncoding=\"UTF-8\"%><br><%@include file=\"/context/mytags.jsp\"%>");
        ...
        // html = html.replace("<input id=\"jformHiddenField\" name=\"jformHiddenField\" type=\"text\"
        // value=\"@@@{@@{entityName?uncap_first}.jformHiddenField}\" style=\"width: 150px\"
        // class=\"inputxt\" >", "");
        html = html.replace("@@@", "${'$'}");
    ...
    private String replaceAddJSP(String cgformJspHtml) {
        ...
        while (cgformJspHtml.indexOf("#{") > 0) {
            ...
            cgformJspHtml = cgformJspHtml.replace(key, "<input id='" + JeecgReadTable.formatField(realKey) + "' name='" + JeecgReadTable.formatField(realKey)
                    + "' type='text' value='${'$'}{${entityName?uncap_first}." + JeecgReadTable.formatField(realKey) + "}' style='width: 150px' class='inputxt' >");
        }
