...
public class TableSQLServerHandleImpl implements DbTableHandleI {
    ...
    private String getUpdateFieldDesc(ColumnMeta cgfromcolumnMeta, ColumnMeta datacolumnMeta) {
        ...
        if (cgfromcolumnMeta.getColunmType().equalsIgnoreCase("string")) {
            result = cgfromcolumnMeta.getColumnName() + " varchar(" + cgfromcolumnMeta.getColumnSize() + ")" + " "
                    + (cgfromcolumnMeta.getIsNullable().equals("Y") ? "NULL" : "NOT NULL");
            ...
            result = cgfromcolumnMeta.getColumnName() + " varbinary(" + cgfromcolumnMeta.getColumnSize() + ")" + " "
                    + (cgfromcolumnMeta.getIsNullable().equals("Y") ? "NULL" : "NOT NULL");
        }
        // result += (StringUtils.isNotEmpty(cgfromcolumnMeta.getFieldDefault())?" DEFAULT
        // "+cgfromcolumnMeta.getFieldDefault():" ");
        return result;
    }
