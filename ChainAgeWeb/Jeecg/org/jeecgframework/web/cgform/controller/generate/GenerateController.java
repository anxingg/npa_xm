...
public class GenerateController extends BaseController {
    ...
    public void dogenerate(CgFormHeadEntity cgFormHead, GenerateEntity generateEntity, CreateFileProperty createFileProperty, HttpServletRequest request,
    ...
    @ResponseBody
    public void dogenerateOne2Many(CodeParamEntity codeParamEntityIn, GenerateSubListEntity subTableListEntity, String jspMode, HttpServletRequest request,
        ...
        try {
            ...
            if (modeEnum != null) {
                ...
                j.setMsg(codeParamEntityIn.getFtlDescription() + "：功能生成成功，请刷新项目重启，菜单访问路径：" + CodeStringUtils.getInitialSmall(codeParamEntityIn.getEntityName())
                        + "Controller.do?list");
            } else {
                j.setMsg("代码生成器不支持该页面风格");
            }
