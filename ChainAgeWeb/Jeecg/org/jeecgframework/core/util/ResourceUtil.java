...
public class ResourceUtil {
     ...
     * 动态数据源参数配置【缓存】
     */
    // public static Map<String, DynamicDataSourceEntity> dynamicDataSourceMap = new HashMap<String,
    ...
    /**
     * 属性文件[resources/sysConfig.properties] #默认开启模糊查询方式 1为开启 条件无需带*就能模糊查询[暂时取消] fuzzySearch=0
     */
