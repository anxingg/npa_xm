...
/**
 * 
 * 类描述：CriteriaQuery类是对hibernate QBC查询方法的封装，需要的参数是当前操作的实体类 张代浩 @date： 日期：2012-12-7 时间：上午10:22:15
 * 
 * @version 1.0
 */
public class CriteriaQuery {
    ...
    public CriteriaQuery(Class entityClass, DataTables dataTables) {
        ...
        this.detachedCriteria = DetachedCriteria.forClass(entityClass);
        // this.detachedCriteria = DetachedCriteriaUtil.createDetachedCriteria(entityClass, "start",
        // "_table",fieldstring);
     ...
     * @param query
     * @param source
     * @param dest hql((this_.0 like ? and this_.1 like ?) or this_.2 like ?) 表示法cq.add(cq.or(cq.and(cq,
     *        0, 1), cq, 2))
     * @return
     */
